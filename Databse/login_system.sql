...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2024 at 06:53 PM
...
--
-- Database: `anime_users`
--
CREATE DATABASE IF NOT EXISTS `anime_users` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `anime_users`;
...
(1, 'mrmonster786', '$2y$10$.XCP2JL2EcZZgClcVOceueH0skrcy6svs1oE.tadduoggc/8Lbh8u', 'kowej89839@ridteam.com'),
(2, 'gg', '$2y$10$ac7NAUrbpJPs2GYq2mY.AOYcv6TAk7ET.J688ZZa0p9yt1ndc1Khy', 'sehedoy432@wikfee.com');
...
('root', '[{\"db\":\"login_system\",\"table\":\"users\"}]');
...
('root', '2024-07-10 16:52:14', '{\"Console\\/Mode\":\"collapse\"}');
